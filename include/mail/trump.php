...
<div style="padding-right: 10px; padding-left: 10px; padding-top: 25px; padding-bottom: 10px;">
	<div style="font-size:12px;line-height:14px;text-align:center;color:#ffffff;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;">&nbsp;<span style="font-size:36px; line-height:43px;">﻿Welcome to Camagru</span><br></div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
